      ...
      <div className="hidden md:flex flex-col justify-between p-12 bg-secondary border-r border-border-primary/50 relative overflow-hidden">
        ...
        <div className="my-auto max-w-lg space-y-6 z-10">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-brand/10 border border-brand/20 text-brand rounded-full text-xs font-semibold uppercase tracking-wider">
            <Sparkles size={14} />
            <span>Smart Video Conferencing</span>
          </div>
          ...
          <h2 className="text-4xl lg:text-5xl font-extrabold font-[Outfit] text-white leading-tight tracking-tight">
            ...
            in the <span className="text-brand italic font-serif">Smartest Room</span> online.
          </h2>

          <p className="text-offwhite/60 text-sm font-light leading-relaxed">
            Real-time HD audio/video streams, built-in AI transcription, live summaries, and active noise cancellation tailored for modern developer teams.
          </p>
          ...
          <div className="pt-4 flex items-center gap-4 text-xs text-offwhite/50 border-t border-border-primary/40">
            ...
            <span>Trusted by 50,000+ developers globally</span>
          </div>
        </div>
      ...
      <div className="flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-[400px] p-8 bg-white dark:bg-secondary rounded-3xl border border-gray-200 dark:border-border-primary/60 shadow-xl transition-all duration-300">
          ...
          <div className="mb-6 text-center md:text-left">
            <h3 className="text-2xl font-bold font-[Outfit] text-primary dark:text-white">Welcome Back</h3>
            <p className="text-sm text-secondary dark:text-offwhite/60 mt-1.5 font-light">Sign in to start or join secure developer meetings</p>
          </div>
          ...
          <div className="flex items-center gap-4 my-5 text-xs uppercase tracking-widest text-secondary/40 dark:text-offwhite/30">
            <span className="flex-1 h-px bg-gray-200 dark:bg-border-primary/60" />
            <span className="font-[Outfit]">or</span>
            <span className="flex-1 h-px bg-gray-200 dark:bg-border-primary/60" />
          </div>

          <button 
            onClick={handleDemoLogin} 
            className="w-full inline-flex items-center justify-center gap-1.5 px-4 py-2.5 text-sm font-medium rounded-xl border border-gray-300 dark:border-border-primary hover:border-primary dark:hover:border-white hover:bg-gray-50 dark:hover:bg-surface-hover cursor-pointer transition-all duration-150 text-primary dark:text-white bg-transparent disabled:opacity-55 font-[Outfit]"
            disabled={isLoading}
          >
          ...
          <div className="text-center mt-6 text-sm font-[Outfit] text-secondary dark:text-offwhite/60">
            ...
            <Link to="/signup" className="font-semibold text-primary dark:text-brand hover:underline">Create account</Link>
          </div>
        </div>
      </div>
    </div>
